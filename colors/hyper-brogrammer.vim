...
hi Cursor ctermfg=234 ctermbg=231 cterm=NONE guifg=#2d2d2d guibg=#ecf0f1 gui=NONE
...
hi LineNr ctermfg=244 ctermbg=236 cterm=NONE guifg=#838586 guibg=#2d2d2d gui=NONE
hi VertSplit ctermfg=240 ctermbg=240 cterm=NONE guifg=#575858 guibg=#2d2d2d gui=NONE
hi MatchParen ctermfg=167 ctermbg=NONE cterm=underline guifg=#e74c3c guibg=NONE gui=underline
hi StatusLine ctermfg=231 ctermbg=240 cterm=bold guifg=#ecf0f1 guibg=#2d2d2d gui=bold
hi StatusLineNC ctermfg=231 ctermbg=240 cterm=NONE guifg=#ecf0f1 guibg=#2d2d2d gui=NONE
...
hi Folded ctermfg=241 ctermbg=234 cterm=NONE guifg=#606060 guibg=#2d2d2d gui=NONE

hi Normal ctermfg=231 ctermbg=234 cterm=NONE guifg=#ecf0f1 guibg=#2d2d2d gui=NONE
...
hi NonText ctermfg=22 ctermbg=234 cterm=NONE guifg=#30312a guibg=#2d2d2d gui=NONE
...
hi SpecialKey ctermfg=22 ctermbg=236 cterm=NONE guifg=#f1530f guibg=#2d2d2d gui=NONE
...
hi SpellBad term=reverse ctermfg=167 ctermbg=224 guibg=#fff gui=undercurl guisp=Red
...
hi SignColumn ctermfg=244 ctermbg=236 guifg=#838586 guibg=#2d2d2d
